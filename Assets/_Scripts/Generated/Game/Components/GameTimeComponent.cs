...
public partial class GameContext {
    ...
    public GameEntity SetTime(float newDeltaTime, float newTimeSinceLevelLoad) {
        if (hasTime) {
        ...
        entity.AddTime(newDeltaTime, newTimeSinceLevelLoad);
        return entity;
    }

    public void ReplaceTime(float newDeltaTime, float newTimeSinceLevelLoad) {
        var entity = timeEntity;
        if (entity == null) {
            entity = SetTime(newDeltaTime, newTimeSinceLevelLoad);
        } else {
            entity.ReplaceTime(newDeltaTime, newTimeSinceLevelLoad);
        }
    }
...
public partial class GameEntity {
    ...
    public void AddTime(float newDeltaTime, float newTimeSinceLevelLoad) {
        ...
        component.timeSinceLevelLoad = newTimeSinceLevelLoad;
