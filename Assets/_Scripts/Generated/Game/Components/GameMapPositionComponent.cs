...
public partial class GameEntity {
    ...
    public void AddMapPosition(UnityEngine.Vector2Int newValue) {
        var index = GameComponentsLookup.MapPosition;
        var component = (MapPositionComponent)CreateComponent(index, typeof(MapPositionComponent));
        component.Value = newValue;
        AddComponent(index, component);
    }

    public void ReplaceMapPosition(UnityEngine.Vector2Int newValue) {
        var index = GameComponentsLookup.MapPosition;
        var component = (MapPositionComponent)CreateComponent(index, typeof(MapPositionComponent));
        component.Value = newValue;
